...
`opportunity -> language model analysis -> validated ProductionBrief -> script generation -> validated ScriptPlan -> local voiceover (measured durations) -> composition -> rendered VideoArtifact with voice -> QA -> human review`
