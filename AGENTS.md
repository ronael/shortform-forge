...
Current V0 scope: manually triggered clipping of authorized source media into a vertical candidate with captions, structured artifacts, and QA. Do not build autonomous 24/7 automation, trend crawling, publishing APIs, dashboards, cloud infrastructure, billing, auth, or speculative platform abstractions yet.
